...
// This class will process the response
 ...
 * (Plain Old Java Objects), or to and from a general-purpose JSON Tree Model */
        ...
        try {
            ...
            /**     // JsonNode is often used to convert data into JSON
             // 👉 mapper.readTree() reads JSON and builds a navigable tree (JsonNode)
             // so you can traverse and extract values without creating a custom Java class. */
...
/** 👉 mapper.readTree() reads JSON and builds a navigable tree (JsonNode)
 // so you can traverse and extract values without creating a custom Java class. */
    ...
    // Overall: This was an excellent      => RESULT
